...
class Ui_Enter_employee(QtWidgets.QMainWindow):
    def __init__(self,parent=None):
        super(Ui_Enter_employee, self).__init__(parent)
        uic.loadUi("ui/Enter_new_employee3.ui",self)
        self.show()
        
        #self.ismet = QtWidgets.QLabel(self.parent, text = "Nesto")
        
              
        self.pushButton_save_employee.clicked.connect(self.enter_employee)
        self.pushButton_save_employee.clicked.connect(self.message_reg)
        self.pushButton_save_employee.clicked.connect(self.closeing)
